    ...
    return(
        <div className="grid sm:grid-cols-3 bg-slate-950 text-white h-10">
            ...
            <div className="flex gap-10 text-xl">
                ...
                <button onClick={handleproject} className="mx-2 mt-0 h-9 w-32 rounded-md bg-gray-900 px-3 py-2 text-sm font-semibold text-white shadow-lg shadow-gray-500/50 hover:bg-gray-800">PROJECTS</button>
